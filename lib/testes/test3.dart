...
class SistemaAcionistas {
  List<String> obterAnalisesDesempenho(
    ...
    //implementando o filtro das análises dentro do período especificado. Vou criar uma lista para armazenar as análises filtradas e use um loop for para filtrar as análises.

    final analisesFiltradas = <String>[];

    for (final analise in analises) {
      if (analise.data.isAfter(dataInicial) &&
          analise.data.isBefore(dataFinal) || analise.data == dataInicial || analise.data == dataFinal) {
